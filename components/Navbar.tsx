          ...
          <div className="flex flex-col sm:flex-row w-full">
            ...
            <div className="w-full sm:w-[60%] p-6 sm:p-8 bg-white border-b sm:border-b-0 sm:border-r border-gray-100 flex flex-col justify-between gap-8">
              <div>
                ...
                <Link href="/?product=business" onClick={() => setProductsOpen(false)} className="flex items-start gap-4 group">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <Link href="/?product=desktop" onClick={() => setProductsOpen(false)} className="flex items-center gap-3 group">
                  ...
                  <Link href="/?product=mobile" onClick={() => setProductsOpen(false)} className="flex items-center gap-3 group">
                    <div className="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center text-red-500 border border-gray-100 shrink-0">
            ...
            <div className="w-full sm:w-[40%] p-6 sm:p-8 bg-white flex flex-col">
              ...
              <div className="border-t border-gray-100 pt-6 mt-auto space-y-4">
                ...
                <Link href="/?page=language" onClick={() => setProductsOpen(false)} className="flex items-center gap-2.5 text-[14px] font-medium text-gray-700 hover:text-red-600 transition-colors">
